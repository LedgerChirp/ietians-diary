        ...
        <View>
          ...
          <View className="flex flex-col items-center">
            <View>
              {image && (
                <Image
                  ...
                  className="w-24 h-24 mx-4 my-2 rounded-full"
                  resizeMode="center"
                />
              )}
              <View className="absolute left-[90px] top-[70px] p-1 bg-cyan-100 rounded-full">
            ...
            <View className="flex items-center">
              <View className="flex flex-row items-center justify-center flex-wrap w-40">
                <TextInput
                  maxLength={15}
                  className="font-[900] text-xl mr-2"
                  value={firstName}
                  onChangeText={(e) => {
