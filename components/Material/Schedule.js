...
const Notes = () => {
    ...
    // Array Map method 
    // const arr = new Array(10).fill().map((val, key) => {
    //     return (
    //         <SingleFile key={key} />
    //     );
    // });
        ...
        <SafeAreaView>
            ...
            >
                <View className="mb-20">
                    {NoteInfo && NoteInfo.map((value, key) => {
                        return (
                            <TouchableOpacity key={key} >
                                <View className="flex-row mt-3 items-center justify-around p-2 bg-[#F1F1F1] mx-2 rounded-2xl">
                                    ...
                                    <View className="flex-col items-center">
                                        ...
                                        <Text className="text-xs text-[#808080]">{value.date}</Text>
                                    </View>
                                </View>
                            </TouchableOpacity>
                        )
...
// Productivity File as a single functional component
...
//                 <Text className="text-xs text-[#808080]">Uploaded</Text>
//                 {/* <Text className="text-xs text-[#808080]">12/2/23</Text> */}
//                 <Text className="text-xs text-[#808080]">{props.date}</Text>
//             </View>
//         </View>
//     );
// }
